...
ent-CrateVendingMachineRestockGetmoreChocolateCorpFilled = Ящик пополнения запасов для автомата Getmore Chocolate Corp
    .desc = Содержит ящик для пополнения запасов для автомата Getmore Chocolate Corp.
ent-CrateVendingMachineRestockChangFilled = Ящик для пополнения запасов Mr. Chang
    .desc = Содержит ящик для пополнения запасов для автомата Mr. Chang.
ent-CrateVendingMachineRestockDiscountDansFilled = Ящик для пополнения запасов Discount Dans
    .desc = Содержит ящик для пополнения запасов для автомата Discount Dan's.
ent-CrateVendingMachineRestockDonutFilled = Ящик для пополнения запасов Monkin' Donuts
    .desc = Содержит ящик для пополнения запасов для автомата Monkin' Donuts.
