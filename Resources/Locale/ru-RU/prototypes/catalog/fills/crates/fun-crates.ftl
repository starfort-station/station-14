...
ent-CrateFunWaterGuns = Ящик с водяными пистолетами
    .desc = Летнее специальное предложение с разнообразными яркими водяными пистолетами. Вода в комплект не входит.
ent-CrateFunSyndicateSegway = ящик с сегвеем синдиката
    .desc = { ent-CrateLivestock.desc }
ent-CrateFunBoxing = Боксерский ящик
    .desc = Хотите создать подпольный бойцовский клуб или провести турнир среди команды станции? Этот ящик для вас!
