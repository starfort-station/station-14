...
cuffable-component-start-uncuffing-observer = { $user } начинает снимать наручники { $target }!
cuffable-component-start-uncuffing-target-message = Ты начинаешь снимать наручники { $targetName }.
