...
medicine-dropper-user-interface-title = капельница
comp-dropper-ui-settings = Настройка переливания
comp-dropper-ui-quantity = Количество:
comp-dropper-ui-frequency = Частота (в секундах):

comp-dropper-residual-solution-pack = Остаток:
comp-dropper-ui-solution-pack-null-residual = 0/0

comp-dropper-ui-needle-label = Игла:
