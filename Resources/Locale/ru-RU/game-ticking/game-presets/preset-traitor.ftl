...
traitor-role-uplink-code =
    .
    Установите рингтон на ноты { $code }, чтобы заблокировать или разблокировать ваш аплинк.
    Не забывайте блокировать и менять его, иначе команда станции легко обнаружит его!
# не нужен весь текст вкуса для меню персонажа
...
traitor-role-uplink-code =
    Установите рингтон на ноты {$code} что бы разблокировать или заблокировать свой аплинк.
    Не забывайте блокировать его и менять код, иначе экипаж станции с легкостью откроет его!
