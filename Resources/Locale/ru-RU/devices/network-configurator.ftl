...
network-configurator-link-mode-stopped = Остановлено связывание.
network-configurator-mode-link = Связывание
network-configurator-mode-list = Список
network-configurator-switched-mode = Переключение режима на: { $mode }
# Verbs
network-configurator-save-device = Сохранить устройство
network-configurator-configure = Настроить
network-configurator-switch-mode = Режим коммутатора
network-configurator-link-defaults = Параметры соединения по умолчанию
network-configurator-start-link = Запустить связывание
network-configurator-link = Связывание
# ui
...
# examine
network-configurator-examine-mode-link = [color=red]Ссылка[/color]
...
network-configurator-examine-switch-modes = Нажмите { $key } для переключения режимов
# item status
network-configurator-item-status-label =
    Текущий режим: { $mode }
    { $keybinding } для переключения режима
