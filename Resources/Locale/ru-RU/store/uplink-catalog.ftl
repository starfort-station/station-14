...
uplink-gloves-north-star-desc = Пара перчаток, которые значительно сокращают время задержки удара, позволяя избивать людей до смерти шквалом ударов.
# Explosives
...
uplink-uplink-implanter-name = Аплинк имплантер
uplink-uplink-implanter-desc = Незаметный заказ оборудования без использования КПК. Глотайте телекристаллы, чтобы пополнить аплинк.
# Bundles
...
uplink-rigged-boxing-gloves-name = Усиленные боксерские перчатки
uplink-rigged-boxing-gloves-desc = Порхать как бабочка, жалить как пчела.
