...
uplink-grenadier-rig-name = Нагрудное снаряжение гренадера
uplink-grenadier-rig-desc = Все, что нужно для шумной вечеринки: 4 разрывные гранаты, 2 гранаты EMP и 2 минибомбы в нагрудной установке.
...
uplink-reinforcement-radio-monkey-name = Телепортатор для усиления обезьян
uplink-reinforcement-radio-monkey-desc = Вызов дрессированной обезьяны для помощи. Поставляется с одной синдикатской сигаретой.
...
uplink-dna-scrambler-implanter-name = Имплантат ДНК-скрамблера
uplink-dna-scrambler-implanter-desc = Одноразовый имплантат, который может быть активирован для изменения вашей ДНК и придания вам совершенно нового облика, а также имеет функцию отмены изменений. Не может скремблировать уже скремблированную ДНК.
uplink-emp-implanter-name = Имплантатор ЭМИ
uplink-emp-implanter-desc = При активации выдает небольшой импульс ЭМИ, который лишает энергии находящуюся поблизости электронику; может быть использован три раза, прежде чем разрядится внутренняя батарея.
uplink-micro-bomb-implanter-name = Имплантатор микробомб
uplink-micro-bomb-implanter-desc = Взрывается при смерти или ручной активации этого импланта. Уничтожает тело вместе со всем оборудованием.
...
uplink-meds-bundle-desc = Все, что нужно для возвращения товарищей в бой: в основном, боевой аптечка, дефибриллятор и три боевых медипенса.
uplink-ammo-bundle-name = Набор боеприпасов
uplink-ammo-bundle-desc = Перезарядка! Содержит 4 магазина для C-20r, 4 барабана для Bulldog и 2 ящика с патронами для L6 SAW.
uplink-sniper-bundle-name = Снайперский набор
uplink-sniper-bundle-desc = Незаметный кейс, содержащий христов, 10 запасных патронов и удобную маскировку.
# Bundles
...
uplink-holy-hand-grenade-desc = Господи, благослови эту ручную гранату Твою, дабы по милости Твоей разнести врагов Твоих на мелкие кусочки.
...
uplink-combat-medkit-desc = Боевой медицинский набор, предназначенный для лечения боевых травм.
uplink-combat-medipen-name = Боевой медицинский пистолет
uplink-combat-medipen-desc = Одноразовый медицинский пистолет, содержащий химические вещества, восстанавливающие большинство видов повреждений.
