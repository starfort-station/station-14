...
job-description-brigmedic = Спасайте заключённых, которые хотят сделать себе вскрытие.
...
job-description-rd = Руководите научным и экспедиционным отделом, открывайте новые технологии, получайте и исследуйте артефакты, и проводите эксперименты.
