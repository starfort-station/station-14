...
signal-port-name-doorbolt = Дверной засов
signal-port-description-doorbolt = Переключает дверной засов.
...
signal-port-name-hold-open = Удержание
...
signal-port-description-logic-input-a = Первый вход логических ворот.
signal-port-name-logic-input-b = Вход B
signal-port-description-logic-input-b = Второй вход логических ворот.
signal-port-name-logic-input = Вход
signal-port-description-logic-input = Вход детектора фронтов, не может быть импульсным сигналом.
