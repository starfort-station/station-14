...
ent-FoodCondimentBottleBBQ = бутылка cоуса барбекю
    .desc = Салфетки в комплект не входят.
ent-BaseFoodShaker = пустая солоница
    .desc = Солоница, используемый для хранения и раздачи специй.
ent-FoodShakerEmpty = пустая солоница
    .desc = Солоница, используемый для хранения и раздачи специй.
ent-FoodShakerSalt = солонка
    .desc = Соль. Предположительно, из космических океанов.
ent-FoodShakerPepper = солоница для перца
    .desc = Часто используется для ароматизации пищи или заставляет людей чихать.
