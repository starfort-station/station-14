...
ent-TrashBananaPeel = банановая кожура
    .desc = { ent-BaseItem.desc }
ent-TrashBananiumPeel = бананиновая кожура
    .desc = { ent-BaseItem.desc }
...
ent-FoodHellblossom = адоцвет
    .desc = Огонь, Огонь, Огонь!
ent-FoodLimitcane = лимиткейн
    .desc = Для тех, кто любит военные преступления.
