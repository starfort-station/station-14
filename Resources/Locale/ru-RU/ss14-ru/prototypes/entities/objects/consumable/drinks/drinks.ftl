...
ent-DrinkCogChampBase = зубчатое стекло
    .desc = Эта смесь коньяка, отвертки и сварочного топлива точно заставит вас увидеть свет!
...
ent-DrinkTheMartinez = бокал мартинеза
    .desc = Легенда о бегущем по краю. Помнят по пьянке, забывают по пьянке.
