...
ent-FoodBreadSausageSlice = ломтик колбасного хлеба
    .desc = Не думайте об этом слишком много.
...
ent-FoodBreadCorn = кукурузный хлеб
    .desc = Хороший домашний кукурузный хлеб в деревенском стиле, с корнями, стреляющий из револьвера, с папиным вкусом.
...
ent-FoodBreadButteredToast = тост с маслом
    .desc = Хрустящий.
ent-FoodBreadFrenchToast = тост
    .desc = Кусочек хлеба, смоченный во взбитой яичной смеси.
ent-FoodBreadGarlicSlice = чесночный хлеб
    .desc = Увы, он ограничен.
ent-FoodBreadJellySlice = желейный тост
    .desc = Как будто наука собирается отдать свои слизи за тост!
ent-FoodBreadTwoSlice = две дольки
    .desc = Стильно.
