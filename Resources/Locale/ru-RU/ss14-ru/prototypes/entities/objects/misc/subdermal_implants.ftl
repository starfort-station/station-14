...
ent-DeathRattleImplant = имплант смертохрипа
    .desc = отправляет сообщение с указанием вашего местоположения на радиоканал синдиката, когда вы впадаете в критическое состояние или погибаете.
