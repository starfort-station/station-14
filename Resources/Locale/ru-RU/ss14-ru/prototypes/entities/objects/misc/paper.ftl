...
ent-PenCentcom = ЦентКом ручка
    .desc = Пытаясь сохранить "власть" бюрократии Cybersun, NT сделала копию кибер-ручки в своём корпаративном стиле.
...
ent-RubberIncorrectquery = печать Некорректная форма
    .desc = Ты действительно не можешь нормально написать своё грёбанное заявление?
ent-RubberStampApprovedbyCC = печать ОДОБРЕНО Центкомом
    .desc = Неужели ты смог это сделать?
ent-StationGoalPaper = цель станции
    .desc = Кажеться у вас много работы
