...
ent-ExosuitFabricatorMachineCircuitboard = фабрикатор экзокостюмов (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-ResearchAndDevelopmentServerMachineCircuitboard = сервер R&D (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
...
ent-SMESMachineCircuitboard = СМЭС (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-CellRechargerCircuitboard = подзарядки батарей (машинная плата)
    .desc = Печатная плата машины для перезарядки ячеек.
ent-WeaponCapacitorRechargerCircuitboard = перезарядное устройство (машинная плата)
    .desc = Машинная печатная плата для перезарядного устройства.
