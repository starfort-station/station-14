...
ent-EmergencyOxygenTank = аварийный кислородный баллон
    ...
    .suffix = { "" }
ent-EmergencyAirTank = аварийный баллон с воздухом
    .desc = Используется в чрезвычайных ситуациях. Содержит мало воздуха, поэтому постарайтесь сохранить его до тех пор, пока он вам действительно не понадобится.
    .suffix = { "" }
ent-EmergencyNitrogenTank = аварийный баллон с азотом
    .desc = Используется в чрезвычайных ситуациях. Содержит мало азота, поэтому постарайтесь сохранить его до тех пор, пока он вам действительно не понадобится.
    .suffix = { "" }
ent-ExtendedEmergencyOxygenTank = аварийный кислородный баллон повышенной ёмкости
    .desc = Используется в чрезвычайных ситуациях. Содержит кислород
    .suffix = { "" }
