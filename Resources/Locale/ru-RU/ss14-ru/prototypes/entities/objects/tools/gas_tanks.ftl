...
ent-EmergencyAirTank = аварийный воздушный баллон
    .desc = Используется в чрезвычайных ситуациях. Содержит очень мало кислорода, поэтому старайтесь беречь его до тех пор, пока он действительно не понадобится.
