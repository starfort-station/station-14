...
ent-VendingMachineRestockChemVend = набор пополнения ХимВенд
    .desc = Ящик, наполненный химикатами и покрытый опасными на вид ромбами NFPA. Загрузите его в ХимВенд, чтобы пополнить его.
ent-VendingMachineRestockExpeditionEquipment = набор пополнения ЭкспедиторМаг
    .desc = Вы действительно решили растачивать имущество NanoTrasen?
ent-VendingMachineRestockExpeditionDrobeEquipment = набор пополнения ЭкспедиторШкаф
