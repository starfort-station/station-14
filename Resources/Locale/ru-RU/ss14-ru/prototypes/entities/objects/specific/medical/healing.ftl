...
ent-RegenerativeMesh = регенеративная сетка
    .desc = Применяется для лечения даже самых неприятных ожогов. Эффективен также при ожогах едкими веществами.
...
ent-Brutepack1 = { ent-Brutepack }
    ...
    .suffix = Один
ent-MedicatedSuture = медицинский шов
    .desc = Шов, пропитанный лекарством, эффективно лечит тупую травму и закрывает раны.
