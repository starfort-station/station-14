...
ent-ClothingMaskGasSwat = противогаз SVAT
...
ent-ClothingMaskBreathMedicalSecurity = медицинская маска военного образца
    .desc = Медицинская маска с небольшим слоем защиты от повреждений и вирусов, подобная тем, что использовались в медицинских подразделениях первой корпоративной войны.
...
ent-ClothingMaskJackal = маска шакала
    .desc = Лучше не поворачиваться спиной к обладателю маски, он может укусить.
ent-ClothingMaskBat = маска летучей мыши
    .desc = Ночью - кровосос, а днем - милый, ослепленный зверек.
ent-ClothingMaskSexyClown = сексуальная маска клоуна
    .desc = Некоторые озорные клоуны думают, что так выглядит Хонкомать.
ent-ClothingMaskSexyMime = сексуальная маска мима
    .desc = Эти румяные щечки так и просятся, чтобы их потрепали.
...
ent-ClothingMaskScaredMime = маска испуганного мима
    .desc = Выглядит так, что если бы не маска, он бы закричал.
