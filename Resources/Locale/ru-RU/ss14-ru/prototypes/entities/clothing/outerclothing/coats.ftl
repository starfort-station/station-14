...
ent-ClothingOuterCoatRnd = лабораторный халат учёного
    .desc = Костюм, защищающий от небольших разливов химикатов. Имеет фиолетовые полосы на плечах.
ent-ClothingOuterCoatRobo = лабораторный халат робототехника
    .desc = Скорее эксцентричный халат, чем лабораторный. Помогает выдать пятна крови за часть эстетики. Поставляется с красными наплечниками.
ent-ClothingOuterDogi = доги самурая
    .desc = Доги это тип традиционной китайской одежды. Доги сделана из тяжёлой прочной ткани
ent-ClothingOuterCoatParamedicWB = ветровка фельдшера
    .desc = Надежная ветровка фельдшера, для любого космического ветра.
