ent-ClothingUniformJumpsuitAncient = комбинезон эскадрона смерти
...
ent-ClothingUniformJumpsuitJacketMonkey = куртка обезьяны бармена
    .desc = Достойная куртка, для достойной обезьяны.
...
ent-ClothingUniformJumpsuitRoboticist = комбинезон робототехника
    .desc = Это облегающий черный цвет с усиленными швами; отлично подходит для работы на производстве.
