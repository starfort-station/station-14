...
ent-ClothingHeadHelmetHardsuitClown = шлем скафандра клоуна
    ...
    .suffix = { "" }
ent-ClothingHeadHelmetHardsuitExpeditionMedic = шлем скафандра полевого врача
    .desc = Укрепленный современный шлем, на нем есть синяя метка.
    .suffix = полевой врач
ent-ClothingHeadHelmetHardsuitExpeditionTrooper = шлем скафандра солдата
    .desc = Укрепленный современный шлем, на нем есть красная метка.
    .suffix = солдат
ent-ClothingHeadHelmetHardsuitExpeditionScientist = шлем скафандра полевого ученого
