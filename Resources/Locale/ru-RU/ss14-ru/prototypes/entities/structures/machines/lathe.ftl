...
ent-AmmoTechFab = патронный ТехФаб
    .desc = Печатает тот минимум пуль, который может понадобиться бюджетному военному или оружейному заводу. Ничего навороченного.
